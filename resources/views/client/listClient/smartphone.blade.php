...
@section('content')
    <div class="row">
        ...
        <div class="col-md-6">
            <img
                    src="https://i.kinja-img.com/gawker-media/image/upload/t_original/evtwgjgb3xbmtirbyawn.jpg " width="600"
                    alt="Điện thoại" title="Điện thoại" class="image"/>
        </div>
            ...
            @foreach($product as $key =>$item)
                <div class="col-md-3 border border-light bg-white">
                    ...
                    <div class="text-product pb-3">
                        <a href="test/{{$item->id}}" class="text-dark"><p class="text-center mb-0"
                                                         style="font-size: 14px">{{$item->title}}</p></a>
                        <a href="#" class="text-danger"><p class="text-center font-weight-bold mb-0">{{$item->price}}
                                đ </p></a>
                    </div>
                </div>
            @endforeach
