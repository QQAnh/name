            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                   <ul class="nav nav-tabs " style="border-bottom: none">
                       <li class="col-md-9">List Console</li>
                       <li>
                           <a href="/admin/console/create" style="padding: 0; color: white">Create new product</a>
                       </li>
                   </ul>
                </div>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($product as $item)
                                <tr id="{{$item->id}}">
                                    ...
                                    <td>{{$item->price}}</td>
                                    <td>
                                        <a href="/admin/console/{{$item->id}}/edit" id="putUser" class="fa fa-edit"> Edit</a> <p> </p>

                                        <a href="/admin/console/{{$item->id}}/delete" id="putUser" class="fa fa-trash btn-delete"> Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
